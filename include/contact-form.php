...
$place = isset($_POST["widget-contact-form-place"]) ? $_POST["widget-contact-form-place"] : null;
...
$subject = isset($_POST["widget-contact-form-subject"]) ? $_POST["widget-contact-form-subject"] : 'New Message From Ambit Contact Form';
...
if( $_SERVER['REQUEST_METHOD'] == 'POST') {
 ...
 if($email != '') {
				...
				$place = isset($place) ? "Place: $place<br><br>" : '';
                $company = isset($company) ? "Company: $company<br><br>" : '';
                $service = isset($service) ? "Service: $service<br><br>" : '';
                $message = isset($message) ? "Message: $message<br><br>" : '';

                $mail->Body = $name . $email . $phone . $place . $company . $service . $message . '<br><br><br>This email was sent from: ' . $_SERVER['HTTP_REFERER'];
